...
(\lean{evalWord}, \lean{Defect.S202\_translation\_identity}).
...
\item[\textbf{T1$'$}] Lean theorems whose proofs invoke the compiled
  evaluator (\lean{native\_decide}), used \emph{only} in the legacy
  per-instance BFS certificate family
  (\lean{Cert\_m1\_Q8\_S216\_Barrier} and its \lean{Q10} sibling); the
